...
const mockEventDetail = {
  ...
  description: 'Join us for the biggest tech conference of the year featuring industry leaders, innovative workshops, and networking opportunities. This comprehensive event will cover the latest trends in artificial intelligence, blockchain technology, cloud computing, and digital transformation. Network with professionals from top tech companies and startups.',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="relative h-64 md:h-96 overflow-hidden rounded-lg">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <div className="flex items-center space-x-4 text-gray-200">
                    ...
                    <div className="flex items-center">
                      <DollarSign className="w-4 h-4 text-brand-green mr-1" />
                      <span className="font-rubik text-sm">${mockEventDetail.ticketPrice}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Services Needed (for Partners) */}
              <Card className="bg-black/80 border-yellow-600 border">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  <p className="font-rubik text-gray-300">
                    This event is looking for service partners. Estimated budget: <span className="text-brand-green font-medium">${mockEventDetail.estimatedBudget.toLocaleString()}</span>
                  </p>
                  
                  <div className="flex flex-wrap gap-2">
                    {mockEventDetail.servicesNeeded.map(service => (
                    ...
                    <>
                      ...
                      <div className="text-center mb-4">
                        <div className="text-3xl font-bold text-brand-green mb-1">
                          ${mockEventDetail.ticketPrice}
                        </div>
                        <p className="font-rubik text-gray-400 text-sm">per ticket</p>
                      </div>
              ...
              <Card className="bg-black/80 border-gray-600 border">
                ...
                <CardContent className="space-y-3">
                  <div className="p-3 bg-gray-800/50 rounded-lg border border-gray-700">
                    <p className="font-rubik text-white text-sm font-medium">AI Summit 2025</p>
                    <p className="font-rubik text-gray-400 text-xs">March 22 • Los Angeles</p>
                    <p className="font-rubik text-brand-green text-xs">$249</p>
                  </div>
                  <div className="p-3 bg-gray-800/50 rounded-lg border border-gray-700">
                    <p className="font-rubik text-white text-sm font-medium">DevCon West</p>
                    <p className="font-rubik text-gray-400 text-xs">April 5 • Seattle</p>
                    <p className="font-rubik text-brand-green text-xs">$199</p>
                  </div>
                  <Button 
                    variant="outline" 
                    size="sm"
