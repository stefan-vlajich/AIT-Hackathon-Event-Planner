        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <img src={logo} alt="Plan It Logo" className="h-8 w-auto mr-3" />
              <span className="text-xl font-bold">Plan It</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Connecting communities through memorable events and experiences. 
              Discover, create, and share amazing moments together.
            </p>
          </div>
